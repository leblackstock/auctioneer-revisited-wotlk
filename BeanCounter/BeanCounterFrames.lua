...
function private.CreateFrames()
	...
	--Search neutral Auction House data
	...
	frame.neutralCheck:SetScript("OnClick", function() set("util.beancounter.ButtonneutralCheck", frame.neutralCheck:GetChecked() and true or false) private.wipeSearchCache() end)
